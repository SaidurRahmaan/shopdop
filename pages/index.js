...
export default function Home() {
  return (
    <div>
      ...
      <Head>
        <title>Shopdop.com</title>
        <meta name="description" content="Shopdop.com - online best e-commarce site" />
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Shopdop best Online E-commmarce</h1>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Best Product Sell .The best Choies For Future E-commarce site.</p>
          </div>
